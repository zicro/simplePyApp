...
emp_1 = Employee('Omar', 'Larhnimi', 2000)
emp_2 = Employee('Ahmed', 'Eng', 3000)
emp_3 = Employee('Osama', 'Larhnimi', 5000)
emp_4 = Employee('Ali', 'EL haloio', 6000)
